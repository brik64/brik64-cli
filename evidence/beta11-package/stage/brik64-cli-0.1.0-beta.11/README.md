...
Current public beta: `0.1.0-beta.11`
...
## Beta11 Command Surface

`0.1.0-beta.11` strengthens local PCD composition. The main change is semantic
`polymerize` behavior for local import DAGs, plus gates that keep generated
Rust scaffolds warning-free and keep empty workspaces fail-closed in `doctor`.
...
cargo add brik64-core@0.1.0-beta.11
```
