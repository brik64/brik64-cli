...
Current beta candidate: `0.1.0-beta.12`
...
## Beta12 Command Surface

`0.1.0-beta.12` strengthens local security boundaries, SDK parity, and
consent-based telemetry. The main changes are fail-closed symlink/path handling,
redacted feedback and error-report transport, and package checks for the SDK
...
cargo add brik64-core@0.1.0-beta.12
```
