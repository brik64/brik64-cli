# AGENTS.md - brik64-cli-l6-required-gate
...
Repo: `brik64-cli-l6-required-gate`
Lane: `cli-gate`

## Repo Role

Gate lane requiring L6 materialization before CLI release claims.
...
Do not bypass L6-required release gates with manual packaging or synthetic artifacts.

## Evidence And Validation

Expected checks before closing meaningful work: gate scripts and release-readiness checks.
