...
Public/local BRIK64 CLI and release/evidence surface.
...
Do not change public CLI behavior, installer claims, package metadata, or release surfaces without fresh command evidence. npm/PyPI/crates are SDK channels unless release evidence says otherwise.

## Evidence And Validation

Expected checks before closing meaningful work: CLI smoke, package manifest validation, release-train dry-run, targeted tests.
