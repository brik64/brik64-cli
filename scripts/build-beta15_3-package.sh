...
OUT_DIR="$ROOT_DIR/evidence/beta15_3-package"
...
pre_public_gate="$ROOT_DIR/evidence/beta15_3-pre-public-rc/report.json"
...
[[ "$pre_public_gate_decision" == "PASS_BRIK64_CLI_BETA15_3_PRE_PUBLIC_RC_GATE" ]] || failures+=("beta15_3_pre_public_gate_missing_or_invalid:$pre_public_gate_decision")
...
if [[ "${#failures[@]}" -gt 0 ]]; then
  ...
  printf '%s\n' "${failures[@]}" | jq -Rsc \
    --arg version "$VERSION" \
    '{
      schemaVersion:"brik64.cli_beta15_3_package_manifest.v1",
      version:$version,
      decision:"FAIL_BRIK64_CLI_BETA15_3_PACKAGE_BUILT",
      releaseEligible:false,
      failures:(split("\n") | map(select(length > 0)))
    }' > "$MANIFEST_PATH"
  printf 'beta15_3_package_input_gate_failed:%s\n' "${failures[*]}" >&2
  exit 1
fi
...
inputs=(
  ...
  "pcd/beta15_2"
  "pcd/beta15_3"
  "BETA15_3_DEFECT_TAXONOMY.md"
  "BETA15_3_EXTERNAL_AUDIT_PROMPT.md"
  "BETA15_3_REQUIREMENTS_MATRIX.json"
  "evidence/beta15_3-pre-public-rc/report.json"
  "evidence/beta15_3-generated-application-integrity/report.json"
  "evidence/beta15_3-l6-preflight/report.json"
...
jq -n \
  --arg version "$VERSION" \
  --arg packagePath "evidence/beta15_3-package/$PACKAGE_NAME" \
  --arg packageSha "$package_sha" \
  --argjson packageBytes "$(file_size "$PACKAGE_PATH")" \
  '{
    schemaVersion:"brik64.cli_beta15_3_package_manifest.v1",
    version:$version,
    decision:"PASS_BRIK64_CLI_BETA15_3_PACKAGE_BUILT",
    releaseEligible:false,
    lane:"cli_0_1_beta",
    generationClaim:"pcd_first_candidate_with_local_runtime_baseline",
    ...
    inputGates:[{
      ...
      report:"evidence/beta15_3-pre-public-rc/report.json",
      packaged:true
    },{
      decision:"PENDING_BETA15_3_SURFACE_SYNC_CANDIDATE",
      report:null,
      packaged:false,
      blocker:"public_surface_sync_pending"
    },{
      decision:"PASS_BETA15_3_L6_PREFLIGHT_NON_CLAIM",
      report:"evidence/beta15_3-l6-preflight/report.json",
      packaged:true,
      blocker:"beta15_3_l6_materialization_pending"
    }],
    requiredPublicReleaseGates:[
      "beta15_3_package_smoke",
      "github_release_beta15_3",
      "curl_gcp_installer_beta15_3",
      "web_docs_changelog_beta15_3",
      "skills_beta15_3",
      "sdk_beta15_3_marketplaces_or_deferrals",
      "public_claim_scan",
      "live_release_train_verify"
    ],
    boundary:"Beta15.3 local package candidate only. Public release remains blocked until package smoke, GitHub, curl/GCP, docs, web, changelog, SDK, skills, marketplace publication or deferral, and live verification pass atomically."
  }' > "$MANIFEST_PATH"
...
printf 'decision=PASS_BRIK64_CLI_BETA15_3_PACKAGE_BUILT\n'
printf 'releaseEligible=false\n'
printf 'package=evidence/beta15_3-package/%s\n' "$PACKAGE_NAME"
printf 'sha256=%s\n' "$package_sha"
