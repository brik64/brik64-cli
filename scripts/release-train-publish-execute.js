...
function isAllowedGeneratedDirtyFile(file) {
  ...
  if (/^evidence\/beta\d+-(github-verified-signature|l6-factory-bridge|local-candidate|package-smoke|package|publication-preflight|release-checksums)\//.test(file)) {
    return true;
  }
  return [
