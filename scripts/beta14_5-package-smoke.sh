...
PKG_DIR="$ROOT_DIR/evidence/beta14_5-package"
OUT_DIR="$ROOT_DIR/evidence/beta14_5-package-smoke"
...
[[ "$manifest_decision" == "PASS_BRIK64_CLI_BETA14_5_PACKAGE_BUILT" ]] || { echo "package_decision_drift:$manifest_decision" >&2; exit 1; }
...
if [[ ! -e "$EXTRACTED/evidence" ]]; then
  echo "package_missing_beta14_5_evidence_payload" >&2
  exit 1
fi
...
jq -n \
  ...
  '{
    schemaVersion:"brik64.cli_beta14_5_package_smoke.v1",
    version:$version,
    decision:"PASS_BRIK64_CLI_BETA14_5_LOCAL_PACKAGE_SMOKE",
...
printf 'decision=PASS_BRIK64_CLI_BETA14_5_LOCAL_PACKAGE_SMOKE\n'
printf 'checks=30\n'
