...
const outDir = path.join(root, 'evidence', 'beta15_5-public-source-sync');
...
function main() {
  ...
  const report = {
    schemaVersion: 'brik64.cli_beta15_5_public_source_sync_gate.v1',
    version,
    pythonVersion: pyVersion,
    decision: failures.length === 0 ? 'PASS_BETA15_5_PUBLIC_SOURCE_SYNC' : 'FAIL_BETA15_5_PUBLIC_SOURCE_SYNC',
