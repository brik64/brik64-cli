...
PKG_DIR="$ROOT_DIR/evidence/beta11-package"
OUT_DIR="$ROOT_DIR/evidence/beta11-package-smoke"
...
[[ "$manifest_decision" == "PASS_BRIK64_CLI_BETA11_PACKAGE_BUILT" ]] || { echo "package_decision_drift:$manifest_decision" >&2; exit 1; }
[[ "$release_eligible" == "false" ]] || { echo "beta11_candidate_should_not_be_public_release_eligible" >&2; exit 1; }
...
jq -n \
  ...
  '{
    schemaVersion:"brik64.cli_beta11_package_smoke.v1",
    version:$version,
    decision:"PASS_BRIK64_CLI_BETA11_LOCAL_PACKAGE_SMOKE",
...
printf 'decision=PASS_BRIK64_CLI_BETA11_LOCAL_PACKAGE_SMOKE\n'
printf 'checks=15\n'
