...
const evidenceDir = path.join(root, 'evidence', 'beta14_5-128-executable');
const scratch = fs.mkdtempSync(path.join(os.tmpdir(), 'brik64-beta14_5-128-'));
const checks = [];
const failures = [];
...
const report = {
  schemaVersion: 'brik64.beta14_5_128_executable_gate.v1',
  version,
  decision: failures.length === 0 ? 'PASS_BETA14_5_128_EXECUTABLE_GATE' : 'FAIL_BETA14_5_128_EXECUTABLE_GATE',
