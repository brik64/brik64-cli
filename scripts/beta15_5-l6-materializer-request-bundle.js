...
const outputRefs = {
  generatedArtifact: 'evidence/beta15_5-l6-generation/generated/brik64-cli.mjs',
  package: 'evidence/beta15_5-package/brik64-cli-0.1.0-beta.15.5.tgz',
  releaseManifest: 'release/manifest.json',
  sealReport: 'evidence/beta15_5-l6-generation/seal_report.json',
};
...
function buildRequest() {
  ...
  return {
    ...
    version,
    lane: 'cli_0_1_beta',
    iterId: 'beta15.5-l6-cli-materializer-request',
...
function verifyBundle() {
  ...
  const validation = validateRequest(request);
  console.log(validation.accepted ? 'PASS beta15.5 L6 materializer request bundle' : 'FAIL beta15.5 L6 materializer request bundle');
  if (!validation.accepted) {
