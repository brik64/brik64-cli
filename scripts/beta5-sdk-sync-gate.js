...
const outDir = path.join(root, 'evidence', 'beta5-sdk-sync');
...
const repos = [
  {
    ...
    files: ['package.json', 'package-lock.json', 'README.md', 'BETA5_SYNC.md'],
    versionFile: 'package.json',
    expected: '"version": "0.1.0-beta.5"'
  },
  {
    id: 'python',
    path: '/Users/carlosjperez/Documents/GitHub/brik64-lib-python',
    files: ['pyproject.toml', 'brik64/__init__.py', 'README.md', 'BETA5_SYNC.md', 'brik64.egg-info/PKG-INFO'],
    versionFile: 'pyproject.toml',
    expected: 'version = "0.1.0b5"'
  },
  {
    id: 'rust',
    path: '/Users/carlosjperez/Documents/GitHub/brik64-lib-rust',
    files: ['Cargo.toml', 'Cargo.lock', 'README.md', 'BETA5_SYNC.md'],
...
function scanRepo(repo) {
  ...
  if (!versionText.includes(repo.expected)) {
    failures.push(`sdk_beta5_version_missing:${repo.id}`);
  }
  return {
    id: repo.id,
    repo: repo.path,
...
function main() {
  ...
  const report = {
    schemaVersion: 'brik64.cli_beta5_sdk_sync_gate.v1',
    version: '0.1.0-beta.5',
    decision: failures.length === 0 ? 'PASS_SDK_BETA5_SYNC' : 'FAIL_SDK_BETA5_SYNC',
    releaseEligible: false,
    marketplacePublicationAllowed: false,
    sdks,
    failures,
    boundary: 'SDK repositories are locally version-aligned; marketplace publication remains blocked until final release authorization.'
  };
