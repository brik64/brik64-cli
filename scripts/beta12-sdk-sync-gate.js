...
const outDir = path.join(root, 'evidence', 'beta12-sdk-sync');
...
const repos = [
  {
    ...
    expected: ['"version": "0.1.0-beta.12"', '@brik64/core@0.1.0-beta.12']
  },
  {
    id: 'python',
    path: '/Users/carlosjperez/Documents/GitHub/brik64-lib-python',
    files: ['pyproject.toml', 'README.md'],
    expected: ['version = "0.1.0b12"', 'brik64==0.1.0b12']
  },
  {
    id: 'rust',
...
function scanRepo(repo) {
  ...
  if (/0\.1\.0-beta\.(?:[4-9]|10|11)\b|0\.1\.0b(?:[4-9]|10|11)\b/.test(joined)) {
...
function main() {
  ...
  const report = {
    schemaVersion: 'brik64.cli_beta12_sdk_sync_gate.v1',
    version,
    pythonVersion: pyVersion,
    decision: failures.length === 0 ? 'PASS_SDK_BETA12_SYNC' : 'FAIL_SDK_BETA12_SYNC',
    releaseEligible: failures.length === 0,
    marketplacePublicationAllowed: failures.length === 0,
    sdks,
    failures,
    boundary: 'SDK repositories must be Beta12 aligned before package publication. This gate does not mutate npm, PyPI, or crates.io.'
  };
