...
const inputPcds = [
  pcd(pcdA, 'pcd/beta16_1/release/l6_cli_materialization_contract.pcd'),
  pcd(pcdB, 'pcd/beta16_1/release/l6_cli_materialization_result_contract.pcd'),
];
const request = {
  ...
  inputPcds,
  outputRefs: {
    generatedArtifact: `evidence/beta16_1-l6-generation/generated/brik64-cli-${version}.mjs`,
  ...
  outputArtifacts: {
    package: {
      path: `evidence/beta16_1-package/brik64-cli-${version}.tgz`,
      sha256: 'a'.repeat(64),
      bytes: 7,
    },
    releaseManifest: {
...
run_materializer() {
  ...
  BRIK64_L6_EXEC_TARGET="$TMP_DIR/exec-target" \
    node "$ROOT/scripts/remote_l6_beta16_1_cli_materializer.js" "@@FILE:$request"
}
...
for version in "0.1.0-beta.16.1"; do
...
printf 'decision=PASS_REMOTE_L6_BETA16_1_CLI_MATERIALIZER_TEST\n'
