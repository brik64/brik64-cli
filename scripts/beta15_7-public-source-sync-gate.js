...
const outDir = path.join(root, 'evidence', 'beta15_7-public-source-sync');
...
function main() {
  ...
  const report = {
    schemaVersion: 'brik64.cli_beta15_7_public_source_sync_gate.v1',
    version,
    pythonVersion: pyVersion,
    decision: failures.length === 0 ? 'PASS_BETA15_7_PUBLIC_SOURCE_SYNC' : 'FAIL_BETA15_7_PUBLIC_SOURCE_SYNC',
